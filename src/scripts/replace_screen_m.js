...
(function (win, $) {
    ...
    $('#in_screen').on('click', function () {
        if ($('#in_screen').hasClass('out_screen_tab') == false) {
            $('#in_screen').removeClass('in_screen_tab');
            $('#in_screen').addClass('out_screen_tab');
        }
        if ($('#out_screen').hasClass('in_screen_tab') == false) {
            $('#out_screen').removeClass('out_screen_tab');
            $('#out_screen').addClass('in_screen_tab');
        }
        $('.grid2').css('display', 'block');
        $('.grid').css('display', 'none');
    });
    $('#out_screen').on('click', function () {
        if ($('#in_screen').hasClass('in_screen_tab') == false) {
            $('#in_screen').removeClass('out_screen_tab');
            $('#in_screen').addClass('in_screen_tab');
        }
        if ($('#out_screen').hasClass('out_screen_tab') == false) {
            $('#out_screen').removeClass('in_screen_tab');
            $('#out_screen').addClass('out_screen_tab');
        }
