...
(function(win,$){
    ...
    $('.qq_talk').on('click',function(){
        window.open('http://wpa.qq.com/msgrd?v=3&uin=1162346843&Site=深圳十分到家服务科技有限公司&Menu=yes');
    });
    // 启动客服
   ...
   var getCityByIP= function (successCallback){
        $.ajax({
            type: 'GET',
            url: 'http://restapi.amap.com/v3/ip?output=json&key=768d532f7ada083c3ce803e7b1865824',
            dataType: 'JSON',
            success : function(res){
