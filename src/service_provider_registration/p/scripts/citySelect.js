...
function CitySelect(address) {
    ...
    this.selectPinlei = $('#select-pinlei');
    this.selectGy = $('#select-gy');
    ...
    this.showPinlei = $('#showPinlei');
    this.showGy = $('#showGy');

    $('#showProvince').html(address.province);
    if (address.city){
        $('#showCity').html(address.city);
    }
}
...
CitySelect.prototype = {
    ...
    bind: function () {
        ...
        self.selectProvince.on('change', function () {
            ...
            self.showProvince.html(provinceName);
            if (id === '0') {
                self.selectCity.html('<option value ="0">市</option>');
            } else {
        ...
        self.selectPinlei.on('change', function () {
            var $this = $(this);
            var pinLei = $this.find("option:selected").text();
            self.showPinlei.html(pinLei);
        });
        self.selectGy.on('change', function () {
            var $this = $(this);
            var gy = $this.find("option:selected").text();
            self.showGy.html(gy);
        });
