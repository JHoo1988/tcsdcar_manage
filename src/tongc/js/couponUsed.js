    ...
    Page.prototype = {
        ...
        bindEvent: function () {
            ...
            $("#btn-search").bind('click', function () {
                ...
                var endTime = $('.content-box [name=endTime]').val();
                if (endTime) {
                    _self.par.endTime = endTime;
                } else {
                    delete  _self.par.endTime;
                }
                var carBodyNo = $("#carBodyNo").val();
                if (carBodyNo) {
                    _self.par.carBodyNo = carBodyNo;
                } else {
                    delete  _self.par.carBodyNo;
                }
        ...
        getData: function (par) {
            ...
            // par.statu = 0;
            $.ajax({
                url: global.url.findAllCouponConsumRecord,
                type: 'GET',
                dataType: 'json',
                data: par,
                beforeSend: function () {
